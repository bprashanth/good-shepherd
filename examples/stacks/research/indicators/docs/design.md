...
- New forms are uploaded via `examples/stacks/research/forms`.
...
See `examples/stacks/research/indicators/docs/dataset_design.md` for the dataset builder plan and append model.
See `examples/stacks/research/indicators/docs/field_aliasing_design.md` for the field aliasing plan and canonical naming rules.
See `examples/stacks/research/indicators/docs/tasks.md` for open follow-ups.
