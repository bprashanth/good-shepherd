    ...
    function createCards() {
        ...
        if (cards.length > 0) {
             ...
             last.content += `<div style="margin-top: 20px; text-align: right; border-top: 1px solid #eee; padding-top: 20px;">
                                  <button onclick="window.location.href='file:///home/desinotorious/src/github.com/bprashanth/good-shepherd/examples/stacks/research/web/index.html'" style="background-color: #28a745; font-weight: bold;">Submit</button>
                              </div>`;
        }
