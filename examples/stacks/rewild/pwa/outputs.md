...
This document describes the artifacts emitted by `examples/stacks/rewild/pwa/`.

This stage now consumes the fixed Stage 1 handoff from `examples/stacks/rewild/setup_wizard/output/selected_plot.json`, copied into `input/selected_plot.json`.
