...
```
┌──────────────────────────────────────────────────────┐
│  Host: examples/stacks/community/                             │
│                                                       │
│  ┌─────────────────┐  ┌──────────────────┐         │
│  │ frappe/         │  │ assistant/        │         │
...
**To be created:**
- `examples/stacks/community/assistant/DESIGN.md` - This plan document (for reference)
- `examples/stacks/community/assistant/.clawdignore` - Security file to hide sensitive data
- `examples/stacks/community/assistant/Dockerfile` - OpenClaw container definition
- `examples/stacks/community/assistant/docker-compose.yml` - Standalone container orchestration (does NOT modify frappe/docker/)
- `examples/stacks/community/assistant/entrypoint.sh` - Container initialization script
- `examples/stacks/community/assistant/frappe_api.py` - Frappe API wrapper functions

**To be updated:**
- `examples/stacks/community/assistant/CONTEXT.md` - Add Frappe DocType schemas and API patterns
- `examples/stacks/community/assistant/SKILL.md` - Expand stage transition rules with API mappings
- `examples/stacks/community/assistant/CONVERSATIONS.md` - Add more realistic conversation flows
- `examples/stacks/community/assistant/HEARTBEAT.md` - Add concrete implementation details

**Existing files to reference:**
- `examples/stacks/community/inputs/data/etl.py` - Frappe API patterns (read-only reference)
- `examples/stacks/community/inputs/data/.env` - Frappe API credentials
- `examples/stacks/community/frappe/docker/docker-compose.yml` - Base docker setup
- `examples/stacks/community/frappe/docker/entrypoint.sh` - Container init pattern
...
**File**: `examples/stacks/community/assistant/.clawdignore`
```
...
**File**: `examples/stacks/community/assistant/Dockerfile`
```dockerfile
...
**File**: `examples/stacks/community/assistant/entrypoint.sh`
```bash
#!/bin/bash
set -e
...
**File**: `examples/stacks/community/assistant/docker-compose.yml` (standalone - does NOT modify frappe setup)
```yaml
version: '3.8'
...
**File**: `examples/stacks/community/frappe/docker/docker-compose.yml`
...
**File**: `examples/stacks/community/assistant/frappe_api.py`
```python
"""
Frappe API wrapper for OpenClaw nursery assistant.
Uses patterns from examples/stacks/community/inputs/data/etl.py
"""
import os
import json
import requests
...
**File**: `examples/stacks/community/assistant/CONTEXT.md` (append to existing content)
...
**File**: `examples/stacks/community/assistant/frappe_helpers.sh`
...
**File**: `examples/stacks/community/assistant/SKILL.md` (replace existing content)
...
**File**: `examples/stacks/community/assistant/CONVERSATIONS.md` (replace existing)
...
**File**: `examples/stacks/community/assistant/HEARTBEAT.md` (replace existing)
...
```bash
cd examples/stacks/community/assistant
...
**File**: `examples/stacks/community/assistant/DESIGN.md`
...
**File**: `examples/stacks/community/assistant/README.md` (keep existing, add sections)
...
- `examples/stacks/community/assistant/frappe_helpers.sh` (create)
- `examples/stacks/community/assistant/CONTEXT.md` (update)
- `examples/stacks/community/assistant/SKILL.md` (update)
- `examples/stacks/community/assistant/CONVERSATIONS.md` (update)
