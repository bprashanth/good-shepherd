...
Create `examples/stacks/community/assistant/requirements.txt`:
...
Edit `examples/stacks/community/assistant/Dockerfile`, add after the `OPENCLAW_DOCKER_APT_PACKAGES` section (again, while you can modify this Dockerfile it must be copied and re-run from within the openclaw repo):
