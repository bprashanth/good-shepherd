...
- Keep the POC app inside `examples/stacks/community/frappe`.
...
See:
- `examples/stacks/community/frappe/schemas/nursery_entities.schema.json`
- `examples/stacks/community/frappe/schemas/nursery_events.schema.json`
- `examples/stacks/community/frappe/schemas/nursery_metadata.schema.json`
