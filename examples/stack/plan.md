...
- `examples/stack/setup_wizard/` mirrors `examples/setup_wizard/`
- `examples/stack/pwa/` mirrors `examples/pwa/`
- `examples/stack/plantwise/` is a new composed component built from existing map/UI patterns
- `examples/stack/indicators/` mirrors `examples/indicators/`
...
- `examples/stack/setup_wizard/`
- `examples/stack/pwa/`
- `examples/stack/plantwise/`
- `examples/stack/indicators/`
- `examples/stack/web/`
...
- `examples/stack/setup_wizard/input/anr_sites.json`
- `examples/stack/setup_wizard/input/anr_metadata.json`
- `examples/alienwise/output/*.tif`
...
- adapt the sibling `examples/pwa/` flow for practitioner site assessment using the selected plot from Stage 2

Required behavior:

- show the selected monitoring plot in a mobile-friendly PWA-like interface
- allow the user to upload subplot images using the same plus/upload interaction style as `examples/pwa`
...
- keep this as a single `examples/stack/pwa/` app
...
- species names prechosen from `examples/stack/indicators/input/`
...
- save the prechosen species list inside `examples/stack/plantwise/input/`
...
- reuse the same `examples/stack/pwa/` app for the later monitoring workflow with different user intent
...
- portrait images from `examples/stack/indicators/input/`
- indicator metadata from `examples/stack/indicators/input/`
...
- static HTML entrypoint like `examples/web/`
- cards linking to:
  - site selection
  - site assessment
  - plantwise
...
- keep this visually stronger than a plain index, but still aligned with the sibling `examples/web/` role
