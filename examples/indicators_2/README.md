...
This stage mirrors `examples/indicators/`, but uses the completed Osuri restoration study as the source instead of upload-time trace mapping.

## Quick Start

### 1) Reuse the compute server from `examples/indicators`
...
```bash
cd /home/desinotorious/src/github.com/bprashanth/good-shepherd/examples/indicators_2/output
...
- The UI is intentionally kept as close as possible to `examples/indicators`.
